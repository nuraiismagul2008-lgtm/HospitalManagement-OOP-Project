...
public class Main {
    ...
    private static void displayMenu() {
        ...
        System.out.println("9. Add Medical Staff (General)");
        System.out.println("10. View All Medical Staff (Polymorphic)");
        System.out.println("11. Make All Staff Work (Polymorphism Demo)");
